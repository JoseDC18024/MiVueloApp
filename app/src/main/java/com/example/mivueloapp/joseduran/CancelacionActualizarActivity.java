...
public class CancelacionActualizarActivity extends AppCompatActivity {
    ...
    public void buscarCancelacion(View view) {
        ...
        if (cursor.moveToFirst()) {
            ...
            hastaFechaEditText.setText(cursor.getString(cursor.getColumnIndex("hasta_fecha")));
            desdeFechaEditText.setText(cursor.getString(cursor.getColumnIndex("desde_fecha")));
