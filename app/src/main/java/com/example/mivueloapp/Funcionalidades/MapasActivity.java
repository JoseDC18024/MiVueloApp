            ...
            fusedLocationClient.getLastLocation().addOnSuccessListener(this, new OnSuccessListener<Location>() {
                ...
                public void onSuccess(Location location) {
                    if (location != null) {
                        ...
                        mMap.addMarker(new MarkerOptions().position(currentLatLng).title("Mi Ubicación Actual"));
...
// Configurar la posición y el marcador en el mapa
        ...
        mMap.addMarker(new MarkerOptions().position(location).title("Marcador inical en San Salvador"));
